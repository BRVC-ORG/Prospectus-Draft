...
- Podcasts from 𝕏 and Spotify up on YouTube channel

    - https://www.youtube.com/@realsatoshinakamoto/podcasts
...
- Factoid, for when The Meme Economy is taken seriously: Baudrillard had a doctorate
...
- 'Signed Transaction. Draft.' playlist

    - https://youtube.com/playlist?list=PLao_DkGx53bc&si=wv8bDZcQgLZW6bnH

# Month of June 2026

29 June

- Square order #US-888856530 delivered
...
- Other workplace certification (?)


21 June

- Þ = ASIC rack sideview powercable

- https://github.com/satoshiofficial/2-9-20/blob/8c62f3c5810d04fa5bc126cf635263e633ac1c5d/2-9-20_Essay_Outline.pdf
...
- Miscellaneous notes for Essay, R&D, other stuff; included here b/c better for organizing; typed from longhand and from various and scattered app-specific sources, just for clerical purposes and for general transparency and the fact that it took, say, 3ish years to draft the Bitcoin white paper: Thought I have had most frequently in the past week, weekandahalf: people instinctively know this I guess but it's worth noting: that it takes talent to be able to do this kind of stuff, mostly the kind of talent and dedication-of-thought(s) that/which still are decidedly rare, but you can bave all of that and then some and but still if not for persistancd, the kind which devs and coders and programmers and the like 
    ...
    - Something else perhaps spoken in hushed tones, whispers, that of any broaching of any kind of non-fleeting talk of 1980s American Market(s) and anything even remotely about Trades, Desks, Options
 
        - If Bitcoin is the great application and use-case of blockchain and blockchain potential: the Internet was and is an interesting thought in terms of what the Founders, any traditional Mason and even anyone involved with the Lewis and Clark Expedition would say is and very well could be a real true test to the simple idea of (in a purely Civics way, which is nice as reminder every now and then, if even in plaintext, for The Author finds hisself randomly frustrated at Twain's very notion of backwoods, prairie-type and murky waterway travels as entertainment and possible entry into the American Literature Canon, even during his time, where parables and aphorisms, folksayings were sometimes rebranded over and over and over again, this long way long before Sinclair's or anyone of the type's examples of what could be done plotwise with just a fraction's more of focus and dedication to what many still call craft, it is simple; Where was Mark T during the time of The U-Boat(s)? Seems he would perchance maybe even think twice on the Literal State-named River running straight through the middle of these United States: The Mississippi River. Even casual enthusiasts of the Free Market(s) would at some point reach the thought of, Why didnt Federal just ever cross the lines randomly and even during the wild times like the 30s, the lead up to the 30s and that being the 20s which had a lot going dor it including the Roaring part(s), which given even that new part of the sentence involving American 1900s happenings,—one could easily arrive at the thought, WHY HAVENT THEY OR ANYONE ATTEMPTED TO AT LEAST START ORGANIZING THE WEB LIKE CLASSICAL/TRADITIONAL WORKING HISTORIANS, GENEALOGISTS OR HISTORIANS HAVE?  Visual: Mel Gibson in that one film where he's an isolated, disfigured former teacher who lives in a big house alone for some reason and but decides to help a local young man/schoolboy with his studies (including the good stuff like Drama/plays, the Classics, et cetera) and stuff by also including daily shovel-dug holes in the ground by exact dimensions. 
...
- The Author (Brock Angelle Thibodeaux a/k/a Satoshi Nakamoto) filed taxes informing the IRS of his Creator/Founder status, as early as 2024
    ...
    - The fact that I applied for and was hired to work at the Edith Garland Dupre Library's STEP Lab's printers (Xerox) and computer lab (all Dell, almost all desktop), was probably another blatantly-obvious piece of supplementary info which would maybe possibly help explain why the concentration 'No concentration' was chosen by The Author in 2011 and kept till graduation; Minor: Business
        ...
        - Clarifying note on the text: the Creative Writing thesis mentioned in the Proof of Identity doc was meant as more of a side-work, independent-thereof of any English undergrad work/studies...if that makes any sense
            ...
            - Also 25B (IT) candidates, or at least 25 Series, are historically supposed to attend AIT in Arizona, at least during and right around GWOT's introduction, with Fort Gordon being included at some time pre-2008 Surge and post-2009's Stop Loss dilemma(s), but that is neither here nor there [respectfully of course]
...
- BRVC YouTube, Rumble channels creation
    ...
    - In terms of traditional-thinking of quote store of value, and in terms of liquidating the past, one must simply look at one example amongst many: two (2) circa2004 abstract paintings, created four (4) days apart, with a visual correlation [happenstance?; intentional?] via a 14-second video featuring the text YOU FRAGGED XXXXXBALLS 4th PLACE WITH 4
        ...
        - "Call of Duty: United Offensive" 14 September 2004
            ...
            - Interesting how antitrust/antimonopoly laws did not apply to in-game server-browsing software/gui/programming, at least it seems, in 2004...or since Steam led the way with its stand-alone platform
                ...
                - Maybe this is why The Author waited two-ish years after reading "Everything and More" (2003) and did plenty of research before contacting the late journalist, professor and author David Foster Wallace
...
- What some may have forgotten or perhaps maybe what we have just realized, perhaps again, in all this post2001 happenings: that some bad actors maybe just wanted to try and quoteunquote Show Up to Work That Day; do not put anything passed individuals with that kind of incredibly-ambiguous motivation(s)
    ...
    - We/BRVC say this because, as the anniversary of the passing nears of one of the finest Rangers and Special Operators (to include Cryptologic Linguists) I have ever met — SFC Antonio Rodriguez KIA 8 February 2020 — working with and helping build web3, web5 and the digital asset economy and not keeping these kinds of things in mind — it would be unethical and against, in quite a few ways, what the Founders had in mind
            ...
            - Being on approved leave around the time of and at the genesis block's creation, what does this mean from a purely academic/tort(s) perspective?
                ...
                - Given Windows XP, Server 2008 and 7 (testing version, leaks, et cetera) at the time and their inherent lack of truly-useful (in terms of cryptography and hashing et al) Hyperthreading and RAM usage, even in the later Service Packs and distros — some posit that the first blocks of Bitcoin were mined with the aid of some kind of Linux distro...; also that Russian proxy servers and maybe Tor and whatnot are hypothesized, it is worth noting that it seems that once classical cryptography and timechain (blockchain) thinking begins for most, common sense (respectfully) seems to take a back seat; the Author has experienced this plenty of times before...but it all gets a little simpler if one just thinks of what was prevalent at the time, among other scholarly-/US Constitution-focused legal works: 
                    ...
                    - The United States Government's 2008/9 Global Financial Crisis responses and aid, and both the GWOT declaration and PATRIOT ACT
                        ...
                        - Interesting side-thought: Does this mean that The Times (—being now entombed within BTC for pretty much ever—) now has a permanent failsafe backup plan, just in case it ever needs to slowly walk passed the graveyard of whatever the Chapter-11-equivalent-is in UK/GBR Accounting? Does the US Constitution have any sayso in relation to Bitcoin's timechain/blockchain, as in now that we have a Space Force, with jurisdiction that includes not only its own branch's rights/powers but also that of the US Air Force's (which Space Force/[+ arguably] Cyber Command technically helmed from)?
...
- Square Credit Card Marketing Kit ordered
    ...
    - Status: "Sent to warehouse" (22:59 PST)
...
- Oracle notes
    ...
    - IMG-as-sata; fileformat(s)-as-GoBetween; win32drivers-as-TestOracles)Я)

    - NIST-like //approved// set of sandbox-like GoBetween technologies or scripts or hashing algorithms   ,   for web2.75,.9xx,4.99999999999999999999999…∞,5.xx
...
- Notes from discourse with a fellow cryptocurrency enthusiast (via Instagram); not sure if GitHub allows for cross-site and or -platform mentioning slash tagging, so will leave blank so as t/be safeside on, tha [sic] 
...
- Manfacturing: ASIC Rack(s), Network rack-like
...
- Life shouldn't always be about fixing things . . . — Elon, during a SpaceX Starship Update

18 October

- Thought Experiment/Note(s) on timechain(s): instead of a bootleg IBM codebook slammed atop something, <i>Catch Fire's</i> exIBM's Texas Prairie's Cardiff Electric's salesman's salesman extraordinaire greets some alternate universe's version of Cardiff's basement office's storage's random wooden business podium prop piece with a copy of soProprietaryItDoesntExistYet GPS satellite chip's code, along with the newest iteration's copy just freshly sent to the manufacturer only days prior: what do we have here?: the possibility of some random, keyword literal RANDOM bystander or unknowing 3rdpartygoer(s), whosoever should happen to possess a priori some randomsounding State's middleofnowhereville's State innameonly Law School (this being the 80s, with the seemingly everelusive in-elaborative-form 80s logic + 80s Business logic being according to the laws of the Universe still intact, timechain reverse- ^see:USC § 1986 … wise) Juris Doctorate degree and also ofcourse the necessary generalized working knowledge of said tech or technologies ——— one would have a very nice usecase for what some could, Precedent-thinking-wise (—academically that-is—), very well call something to the like(s) of, oh I don't know, Pre-Timechain legal thinking and language usage, per 1980s era juris prudence norms and prevales and even onecouldsay prevalence or whatnot; —— but let's imagine for a beat if USC did include said language, just as a purely use-case (viz. your runofthemill 1980s type 'Use Case,' not to be confused with the prevalent, perdominantlyPostLate2000s termiage for a business' or organization's consumerfacing examples his or her or its or their business' previous success in the market(s), with aestheticallypleasingtothenakedeye of the average site or website or intrasite online visitor(s)) type example; no way for even a most-studious 1987-year researcher or energy-researcher with a focus in or on computer hardware, with even further likely slash highlypossible distinctions therein such as assembly or consumer grade or even something described along the lines as macro based and nonironically at that with aforementioned's letter first capitalized, nonsuspect to even the usual seasoned technical of readers of the late yet yet to be entirely scutinized in an intradiscoursian type sense 80s era enthusiast on up to nearpioneering level(s) of pedigree(s) or the like, academia and inthemarkets type(s) speaking, with all due respect of course.  ∈  Mr S Nakamoto of ₿fame no less was officially officially-18-yearsofage at no year other than 1993, in the month of April, 5th day in…;—:5months18days before 21 September 1993: American Seattle-helming Grunge band Nirvana's US vinyl release of their arguably only-second studio album (;and even not at that, now considering…: being that Steve Albini's home located in Pennsylvania State somewhere was used as the quoteunquote recording studio, for obvious reasons known to mostifnotall Wikipedia proponents and casual contributors slash editors, respectively (and respectfully)
...
Some bad actor(s) want to lower the value of a particular fiat currency by demanding that all of its Treasury's Notes be tokenized on a certain chain or any chain at all and by a certain time and date, threatening extra-Legal and -InternationalLaw cyberwarfare-type activities or even leaving their (the bad actor(s)) infuture response(s) intentionally ambiguous, with only vague reference(s) to their name or past ware(s)/botnetweb(s) activities; and they haven't indicated whether they even are aware that proprietary-focused, hybrid-type blockchains like Hyperledger even exist. Unlike in past examples of communication(s)-via-then-en-vogue-internet-meme(s)-culture lexicon/language (i.e., Guccifer), the bad actor or actors or loose collective of disparate elements of several different groups of ware(s)-makers and -distributors choose to speak exclusively via public-facing links created from Google Gemini AI prompts, using only seemingly-boolean-type text prompts/questions, perhaps in an attempt to further skew their country/region/area of origin, e.g. "What if 2000s era botnetweb converted oracle tradfi web5 interoperable exploit" or something along that line, playing on the idea of a novice internet user first trying his or her hand at security exploitation(s), et cetera. It is not clear whether they are legitimately threatening or just making empty threats toward the issuer of said currency's Notes. They also mention having a replica printer just like host country's currency-issuing Mint does; comments at some point that they know most if not all of said Treasury Notes' serial numbers, et cetera, will start duplicating each and tokenizing each on a chain if no response, or, they says, maybe they've already started, who knows. You are receiving said info because you are the vCIO (Virtual Chief Information Officer) of the company which supplies the highly-exclusive software/proprietary-code for currency-printing-machines and its many peripherals, as a thirdparty contractor, as part of a larger managedservices company, which offers "web2.5 Help Desk ticketing support and management" via a traditional proprietary-like ticketing software, for NGOs, 501c3-types and Think Tanks which are undergoing web3 data transfers/conversions due to recent legislation's calling for it in a Congressional bill which included an amicus brief. Your role is usually only technical with oversight of a few remote staff and one (1) governmental employee onsite whom you share as a direct-report role(s) with your counterpart (think of a mid-higher-level GS- type with plenty of technical experience; a seasoned CTO in most respects)

INSTRUCTIONS

Sketch out your first thought(s)/thinking and list which alreadyavailable tools you'd use and which you'd create or compile from others in order to begin a multi-Hat -type response/reaction plan. The exercise is intentional in its non-mentioning of any OS used or which type or make of physical component(s); the effect is to possibly in a way throw off any classicalthinking of Terminal or GreenScreen(s) usage-thinking, mindset(s), on behalf of the testtaker (that means you). You can only communicate via the use of OTPs made of 8x11 legal pads obtained from Amazon's Amazon Basics brand of products, purchased online and delivered from one of their many fine Fulfillment Centers; said bad actor(s) will be expecting to be informed of each individual orders' Amazon proprietary tracking numbers, written in plaintext in binary with a locally-purchased Sharpie Chisel Tip permanent marker, at the bottom of a legal page page's sheet, placed in a designated open-area public space (such as a park or atop the roof of a car parked atop the roof of a parking structure, somewhere easily accessible/viewable via drone or specialized photo-lense). Feel free to use any publicly-available Penetration Testing or Ethical Hacking training/self-study material(s) found online, just so long as you keep a runningtab as you go along of your searchengine and browser history via an .nfo text file, much like the ones included with keygens and wares of the like, to be uploaded to a chain or site chosen by said bad actor(s) in the future at some given pointintime, possibly even as a .torrent file as well to be uploaded concurrently. Zeroday exploit(s) of thirdparty's software are unknown; said bad actor(s) mention hoping you can 'chat about it soon, if that's what you're privy to.' 

TIME GIVEN

13 hour increments for each delivered OTP(s), from time of request to succesful public placement
1week3days9hours in total

- R&D thought experiment/soundboard: What's stopping a State like Louisiana from soft-seceding (in the same jovial 'veign,' if that's the right word to use, as the State of Texas' yearly tradition of filing paperwork to secede from The Union) from the other 49 States (but not in a bad way, or separatist-like way; more like an intra-Nation, 'leadingthecharge,' America First, breaking new digital ground kind of way) and just creating a semi-quasi-independent new Trade Center, apart from the physically-there 1WTC (One World Trade Center, Freed Tower) and others...? The arguments involving post-Katrina and -GlobalFinancialCrisis numbers would more than interest just a few of the more academic-leaning American Economists and Speculators out there...
...
- https://www.opportunitylouisiana.gov/news/south-louisiana-rail-facility-expands-to-create-new-opportunities-for-louisiana-rice-farmers
    ...
    - Chance for AWX (American Water Exchange) (?)
...
- It's worth mentioning that the role of BRVC and myself (Satoshi) is to keep a healthy distance very much <i>away</i> from Bitcoin and the Bitcoin network. Like what's been said before, if Satoshi (myself) were to come back he'd be in line with everyone else, in terms of voting power, consensus-wise. I and BRVC do not plan at all to try and sway the direction of Bitcoin. I've already created it and given it away to the world; it would be unethical to do anything but help with the purely research side of it, from a distance. There is very much a way to help while not influencing the overall direction of BTC. A lot of thought and time went into creating BRVC and deciding to start working with Bitcoin again. It has a lot of potential and I can't wait to get started!

11 October

- Weekly BTC live-trading or live chart-analysis on YouTube for BRVC (?)
